...
function say() {
  var name5 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'zhaoan';
...
var arry = ['jd', 'hk', 'we'];
function sayHellow() {
  console.log('hellow ' + (arguments.length <= 0 ? undefined : arguments[0]) + ',' + (arguments.length <= 1 ? undefined : arguments[1]) + ',' + (arguments.length <= 2 ? undefined : arguments[2]));
}
...
var className2 = function (_className) {
  ...
  function className2() {
    ...
    //可理解为继承的意思
    var _this2 = _possibleConstructorReturn(this, (className2.__proto__ || Object.getPrototypeOf(className2)).call(this));
...
//# sourceMappingURL=0.0f091931f8b92979a1ed.hot-update.js.map